 ...
 */
class SectionEntity extends \App\Data\Entities\Information\SectionEntity implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (SectionEntity $proxy) {
